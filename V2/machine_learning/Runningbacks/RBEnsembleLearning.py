...
class RBEnsembleLearning:
    ...
    def prepare_data(self):
        ...
        #ensure RB folder in model_training directory exists
        if not os.path.exists(self.training_data_dir):
            os.makedirs(self.training_data_dir)

        #save train and test data to model_training directory
        train_data.to_csv(os.path.join(self.training_data_dir, 'train.csv'), index=False)
        test_data.to_csv(os.path.join(self.training_data_dir, 'test.csv'), index=False)
    ...
    def export_predictions(self, test_data, results):
        ...
        predictions_file = os.path.join(self.predictions_path, f'rb_ensemble_predictions_{self.test_season}.csv')
