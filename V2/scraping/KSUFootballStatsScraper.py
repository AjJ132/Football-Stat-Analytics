...
class KSUFootballStatsScraper:
    def __init__(self, seasons, base_save_path='data/fetched/stats'):
    ...
    def process_game(self, game, year):
        ...
        if game['opponentlink']:
            ...
            print(f"Scraping opponent page: {opponent_url}")
        ...
        for year in self.seasons:
            ...
            if games:
                ...
                for game in tqdm(games_formatted, desc=f"Processing games for {year}"):
                    ...
                    if game_data:
                        print(f"Game data saved for {game['date']} vs {game['opponent']}")
                    else: 
